...
from app.domains.document.services.vectorization import VectorStorageLockBusy, store_document_vectors
...
if TYPE_CHECKING:
    ...
    from app.entrypoints.document_worker import DocumentVectorStorageContext, KafkaWorkerRuntime

logger = logging.getLogger("app.domains.document.workers.vectorization_consumer")
