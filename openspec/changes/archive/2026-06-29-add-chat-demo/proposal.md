...
- Add focused tests for route mounting, request validation, missing configuration, provider failure handling, and successful behavior through a test-local mock of the LangChain chat client.
